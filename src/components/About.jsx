  ...
  return (
    <section className="mt-14 md:mt-20" id="about">
      <div className="inline-block">
        <h2 className="font-semibold text-c-main-black-light dark:text-c-main-white-dark md:text-xl text-base">Sobre</h2>
        <hr class="h-[3px] md:mt-[1px] border-0 rounded-full bg-gradient-to-r from-orange-500 via-neutral-500 to-blue-500"></hr>
      </div>
      <p className="text-c-second-text-light dark:text-c-second-text-dark mt-1 md:mt-3 md:text-base text-sm text-justify">
      ...
      <p className="text-c-second-text-light dark:text-c-second-text-dark mt-1 md:mt-2 md:text-base text-sm text-justify">
