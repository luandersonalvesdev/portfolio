  ...
  return (
    <section id="skills" className="mt-14 md:mt-20">
      <div className="inline-block">
        <h2 className="font-semibold dark:text-main-white-dark md:text-xl text-base">Habilidades</h2>
        <hr class="h-[3px] md:mt-[1px] border-0 rounded-full dark:bg-gradient-to-r from-green-400 via-rose-400 to-violet-500"></hr>
      </div>
      <ul className="mt-4 flex flex-wrap dark:text-main-white-dark w-full gap-3">
        {
